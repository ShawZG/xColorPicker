...
QString AppConfig::appVer = QString("v%1.%2.%3").arg(PROJECT_VERSION_MAJOR).arg(PROJECT_VERSION_MINOR).arg(PROJECT_VERSION_PATCH);
...
//    AppConfig::setting = new QSettings(filePath, QSettings::IniFormat);
    AppConfig::setting = new QSettings(QSettings::NativeFormat, QSettings::UserScope, ORGANIZATION, APPLICATION);
    /*
